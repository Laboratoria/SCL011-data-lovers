...
![Evaluación Heurística](https://i.ibb.co/k5RR5F4/evaluacion-Heuristica.png)

  ## **Conclusión**
Según la evaluación realizada, debería existir la opción de  que el usuario pudiera acceder a preguntas frecuentes, o de una sección explicativa sobre las distintas secciones de nuestra pagina.   Lo anterior queda pendiente y se agregara al estado de avance.  
...
Respecto al proyecto además se debiera:
 ...
 - Entregar la información por tema sacando la media de los 4 países
   para tener un referente.
 - Generar gráficos de todos los indicadores tanto por país como por
   Latinoamérica.
 - Poder optar a realizar un comparativo entre la media de Latinoamérica
   y cada País, para una mejor perspectiva del estudiante.
 
 - Hacer una ventana de ayuda y/o Preguntas frecuentes. Con el propósito de que el usuario logre entender a cabalidad el uso de la página.
