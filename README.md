# **Rick And Morty**
Esta es una aplicación rick and morty que contiene  información sobre los personajes de la serie.

## ** Construyendo **

Esta aplicación fue construida usando html , Css y javascript Vanilla . Para ejecutar esta app en su computador debe:

$ git clone https://github.com/Crusiris/SCL011-data-lovers.git
$ cd SCL011-data-lovers
$ npm install
